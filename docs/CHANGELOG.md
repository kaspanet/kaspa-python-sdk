...
- The SilverScript member pins `silverscript-lang` at `2a3961ca`, which tracks rusty-kaspa tag `v2.0.1` — the same upstream line as the core module, though still built as two isolated dependency graphs / extension modules.
