...
### Development
- The crate is now a Cargo workspace; the SilverScript bindings live in `crates/kaspa-silverscript` (a second `cdylib` member) and are injected into the wheel under `kaspa/silverscript/`.
