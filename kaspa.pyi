...
class Wallet:
    ...
    def __new__(cls, network_id: NetworkId, encoding: Encoding, url: builtins.str, resolver: Resolver) -> Wallet: ...
    ...
    def add_event_listener(self, event: EventKind, callback: typing.Callable[..., None, *args: typing.Any, **kwargs: typing.Any) -> None: ...
    def remove_event_listener(self, event: EventKind, callback: None | typing.Callable[..., None] = None) -> None: ...
    def set_network_id(self, network_id: NetworkId) -> None: ...
