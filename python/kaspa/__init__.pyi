...
class Wallet:
    ...
    def wallet_import(self, wallet_secret: builtins.str, wallet_data: Binary) -> dict: ...
    def prv_key_data_enumerate(self) -> list[PrvKeyDataInfo]: ...
    def prv_key_data_create(self, wallet_secret: builtins.str, secret: builtins.str, kind: PrvKeyDataVariantKind, payment_secret: typing.Optional[builtins.str] = None, name: typing.Optional[builtins.str] = None) -> str: ...
    ...
    def accounts_discovery(self, discovery_kind: AccountsDiscoveryKind, address_scan_extent: builtins.int, account_scan_extent: builtins.int, bip39_mnemonic: builtins.str, bip39_passphrase: typing.Optional[builtins.str] = None) -> int: ...
    ...
    def accounts_create_new_address(self, account_id: builtins.str, address_kind: NewAddressKind) -> Address: ...
    def accounts_estimate(self, account_id: builtins.str, priority_fee_sompi: Fees, fee_rate: typing.Optional[builtins.float] = None, payload: typing.Optional[Binary] = None, destination: typing.Optional[typing.Sequence[PaymentOutput]] = None) -> GeneratorSummary: ...
    def accounts_send(self, wallet_secret: builtins.str, account_id: builtins.str, priority_fee_sompi: Fees, payment_secret: typing.Optional[builtins.str] = None, fee_rate: typing.Optional[builtins.float] = None, payload: typing.Optional[Binary] = None, destination: typing.Optional[typing.Sequence[PaymentOutput]] = None) -> GeneratorSummary: ...
    def accounts_get_utxos(self, account_id: builtins.str, addresses: typing.Optional[typing.Sequence[Address]] = None, min_amount_sompi: typing.Optional[builtins.int] = None) -> dict: ...
    def accounts_transfer(self, wallet_secret: builtins.str, source_account_id: builtins.str, destination_account_id: builtins.str, transfer_amount_sompi: builtins.int, payment_secret: typing.Optional[builtins.str] = None, fee_rate: typing.Optional[builtins.float] = None, priority_fee_sompi: typing.Optional[Fees] = None) -> dict: ...
    def accounts_commit_reveal(self, wallet_secret: builtins.str, account_id: builtins.str, address_type: CommitRevealAddressKind, address_index: builtins.int, script_sig: Binary, commit_amount_sompi: builtins.int, reveal_fee_sompi: builtins.int, payment_secret: typing.Optional[builtins.str] = None, fee_rate: typing.Optional[builtins.float] = None, payload: typing.Optional[Binary] = None) -> list[str]: ...
    def accounts_commit_reveal_manual(self, wallet_secret: builtins.str, account_id: builtins.str, script_sig: Binary, reveal_fee_sompi: builtins.int, payment_secret: typing.Optional[builtins.str] = None, fee_rate: typing.Optional[builtins.float] = None, payload: typing.Optional[Binary] = None, start_destination: typing.Optional[typing.Sequence[PaymentOutput]] = None, end_destination: typing.Optional[typing.Sequence[PaymentOutput]] = None) -> list[str]: ...
    def batch(self) -> None: ...
    def flush(self, wallet_secret: builtins.str) -> None: ...
    def retain_context(self, name: builtins.str, data: typing.Optional[Binary] = None) -> None: ...
    def get_status(self, name: typing.Optional[builtins.str] = None) -> dict: ...
    def address_book_enumerate(self) -> None: ...
    def transactions_data_get(self, account_id: builtins.str, network_id: NetworkId, start: builtins.int, end: builtins.int, filter: typing.Optional[typing.Sequence[TransactionKind]] = None) -> dict: ...
    def transactions_replace_note(self, account_id: builtins.str, network_id: NetworkId, transaction_id: builtins.str, note: typing.Optional[builtins.str] = None) -> None: ...
    def transactions_replace_metadata(self, account_id: builtins.str, network_id: NetworkId, transaction_id: builtins.str, metadata: typing.Optional[builtins.str] = None) -> None: ...
