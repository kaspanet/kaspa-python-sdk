...
class Wallet:
    ...
    def __new__(cls, network_id: typing.Optional[NetworkId] = None, encoding: typing.Optional[Encoding] = None, url: typing.Optional[builtins.str] = None, resolver: typing.Optional[Resolver] = None) -> Wallet: ...
    def exists(self, name: typing.Optional[builtins.str]) -> typing.Any: ...
    ...
    def wallet_create(self, wallet_secret: builtins.str, filename: typing.Optional[builtins.str], overwrite_wallet_storage: typing.Optional[builtins.bool], title: typing.Optional[builtins.str], user_hint: typing.Optional[builtins.str]) -> typing.Any: ...
    def wallet_open(self, wallet_secret: builtins.str, filename: typing.Optional[builtins.str], account_descriptors: builtins.bool) -> typing.Any: ...
    def wallet_close(self) -> typing.Any: ...
    def wallet_reload(self, reactivate: builtins.bool) -> typing.Any: ...
    def wallet_rename(self, wallet_secret: builtins.str, title: typing.Optional[builtins.str], filename: typing.Optional[builtins.str]) -> typing.Any: ...
    def wallet_change_secret(self, old_wallet_secret: builtins.str, new_wallet_secret: builtins.str) -> typing.Any: ...
    def wallet_export(self, wallet_secret: builtins.str, include_transactions: builtins.bool) -> typing.Any: ...
    def wallet_import(self, wallet_secret: builtins.str, wallet_data: Binary) -> typing.Any: ...
    def prv_key_data_enumerate(self) -> typing.Any: ...
    def prv_key_data_create(self, wallet_secret: builtins.str, name: typing.Optional[builtins.str], payment_secret: typing.Optional[builtins.str], secret: builtins.str, kind: PrvKeyDataVariantKind) -> typing.Any: ...
    def prv_key_data_remove(self, wallet_secret: builtins.str, prv_key_data_id: builtins.str) -> typing.Any: ...
    def prv_key_data_get(self, wallet_secret: builtins.str, prv_key_data_id: builtins.str) -> typing.Any: ...
    def accounts_enumerate(self) -> typing.Any: ...
    def accounts_create_bip32(self, wallet_secret: builtins.str, account_name: typing.Optional[builtins.str], account_index: typing.Optional[builtins.int], prv_key_data_id: builtins.str, payment_secret: typing.Optional[builtins.str]) -> typing.Any: ...
    def accounts_create_keypair(self, wallet_secret: builtins.str, account_name: typing.Optional[builtins.str], prv_key_data_id: builtins.str, ecdsa: builtins.bool) -> typing.Any: ...
    def accounts_import_bip32(self, wallet_secret: builtins.str, account_name: typing.Optional[builtins.str], account_index: typing.Optional[builtins.int], prv_key_data_id: builtins.str, payment_secret: typing.Optional[builtins.str]) -> typing.Any: ...
    def accounts_import_keypair(self, wallet_secret: builtins.str, account_name: typing.Optional[builtins.str], prv_key_data_id: builtins.str, ecdsa: builtins.bool) -> typing.Any: ...
    def accounts_rename(self, wallet_secret: builtins.str, account_id: builtins.str, name: typing.Optional[builtins.str]) -> typing.Any: ...
    def accounts_discovery(self, discovery_kind: AccountsDiscoveryKind, address_scan_extent: builtins.int, account_scan_extent: builtins.int, bip39_passphrase: typing.Optional[builtins.str], bip39_mnemonic: builtins.str) -> typing.Any: ...
    def accounts_ensure_default(self, wallet_secret: builtins.str, payment_secret: typing.Optional[builtins.str], account_kind: AccountKind, mnemonic_phrase: typing.Optional[builtins.str]) -> typing.Any: ...
    def accounts_activate(self, account_ids: typing.Optional[typing.Sequence[builtins.str]]) -> typing.Any: ...
    ...
    def accounts_estimate(self, account_id: builtins.str, fee_rate: typing.Optional[builtins.float], priority_fee_sompi: Fees, payload: typing.Optional[Binary], destination: typing.Optional[typing.Sequence[PaymentOutput]]) -> typing.Any: ...
    ...
    def accounts_get_utxos(self, account_id: builtins.str, addresses: typing.Optional[typing.Sequence[Address]], min_amount_sompi: typing.Optional[builtins.int]) -> typing.Any: ...
    def accounts_transfer(self, wallet_secret: builtins.str, source_account_id: builtins.str, destination_account_id: builtins.str, payment_secret: typing.Optional[builtins.str], transfer_amount_sompi: builtins.int, fee_rate: typing.Optional[builtins.float], priority_fee_sompi: typing.Optional[Fees]) -> typing.Any: ...
    def accounts_commit_reveal(self, account_id: builtins.str, address_type: CommitRevealAddressKind, address_index: builtins.int, script_sig: Binary, wallet_secret: builtins.str, commit_amount_sompi: builtins.int, payment_secret: typing.Optional[builtins.str], fee_rate: typing.Optional[builtins.float], reveal_fee_sompi: builtins.int, payload: typing.Optional[Binary]) -> typing.Any: ...
    def accounts_commit_reveal_manual(self, account_id: builtins.str, script_sig: Binary, wallet_secret: builtins.str, payment_secret: typing.Optional[builtins.str], fee_rate: typing.Optional[builtins.float], reveal_fee_sompi: builtins.int, payload: typing.Optional[Binary], start_destination: typing.Optional[typing.Sequence[PaymentOutput]], end_destination: typing.Optional[typing.Sequence[PaymentOutput]]) -> typing.Any: ...
    def batch(self) -> typing.Any: ...
    def flush(self, wallet_secret: builtins.str) -> typing.Any: ...
    def retain_context(self, name: builtins.str, data: typing.Optional[Binary]) -> typing.Any: ...
    def get_status(self, name: typing.Optional[builtins.str]) -> typing.Any: ...
    def address_book_enumerate(self) -> typing.Any: ...
    def transactions_data_get(self, account_id: builtins.str, network_id: NetworkId, start: builtins.int, end: builtins.int, filter: typing.Optional[typing.Sequence[TransactionKind]]) -> typing.Any: ...
    def transactions_replace_note(self, account_id: builtins.str, network_id: NetworkId, transaction_id: builtins.str, note: typing.Optional[builtins.str]) -> typing.Any: ...
    def transactions_replace_metadata(self, account_id: builtins.str, network_id: NetworkId, transaction_id: builtins.str, metadata: typing.Optional[builtins.str]) -> typing.Any: ...
    def fee_rate_estimate(self) -> typing.Any: ...
    def fee_rate_poller_enable(self, interval_seconds: builtins.int) -> typing.Any: ...
    def fee_rate_poller_disable(self) -> typing.Any: ...
...
@typing.final
class CommitRevealAddressKind(enum.Enum):
    r"""
...
@typing.final
class PrvKeyDataVariantKind(enum.Enum):
    r"""
